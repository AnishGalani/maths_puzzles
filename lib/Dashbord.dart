    ...
    return Scaffold(
      body: SafeArea(
        child: Container(height: double.infinity,width: double.infinity,alignment: Alignment.center,padding: EdgeInsets.only(top: 5),
          decoration: BoxDecoration(image: DecorationImage(fit: BoxFit.fill,image: AssetImage("image/bg1.jpg"))),
          child: Expanded(
            child: Column(
              children: [
                Expanded (flex: 0,
                    ...
                    children: [
                      InkWell(onTap: () {
                        showDialog(context: context, builder: (context) {
                          return AlertDialog(
                            title: Text("Skip"),
                            content: Text("Are You Sure You Want To Skip This Level? You Can Play Skiped Levels Later By Clicking On PUZZLES Manu From Main Screen"),
                            actions: [
